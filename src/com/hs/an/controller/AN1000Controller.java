...
public class AN1000Controller {
	...
	private static final Logger logger = LoggerFactory.getLogger(AN1000Controller.class);
	...
	public @ResponseBody List<Map<String, Object>> AN1000_SEL(@RequestBody Map<String, Object> param, HttpSession session) {
		...
		List<Map<String, Object>> list = an1000Service.an1000Sel(param, session);
		return list;
	}
