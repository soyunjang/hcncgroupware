...
public class CM1100Controller {
	...
	private static final Logger logger = LoggerFactory.getLogger(CM1100Controller.class);
	...
	public String cm1100(Locale locale, Model model){
		return "CM/CM1100";
	}
	...
	public @ResponseBody List<Map<String, Object>> cm1100_SELECT(@RequestBody Map<String, Object> param) {
		
		List<Map<String,Object>> list = cm1100Service.cm1100Sel(param);
		return list;
	}
	...
	public @ResponseBody List<Map<String, Object>> cm1100Varification(@RequestBody Map<String, Object> param){
		
		List<Map<String, Object>> list = cm1100Service.cm1100Verification(param);
		return list;
	}
	...
	public @ResponseBody Map<String, Object> cm1100Save(@RequestBody Map<String, Object> param, HttpSession session) {
