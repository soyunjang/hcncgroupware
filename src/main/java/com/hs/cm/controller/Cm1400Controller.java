...
public class Cm1400Controller {
	...
	public List<Map <String, Object>> cm1400Save(@RequestBody Map<String, Object> param, @ModelAttribute("User") UserInfo user) {
		return cm1400Service.cm1400Save(param, user);
	}
	...
	public HashMap<String, Object> cm1400DetailSave(@RequestBody Map<String, Object> param, @ModelAttribute("User") UserInfo user) {
		return cm1400Service.cm1400DetailSave(param, user);
	}
}