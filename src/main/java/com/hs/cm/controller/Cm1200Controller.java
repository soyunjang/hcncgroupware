...
public class Cm1200Controller {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/cm1200PasswordReset")
	public  Map<String, Object> CM1200_PWRESET(@RequestBody Map<String, Object> param, @ModelAttribute("User") UserInfo user) {

		Map<String, Object> rtnMap = new HashMap<>();

		try {
			rtnMap = cm1200Service.cm1200PasswordReset(param, user);
		}catch(Exception e) {
			e.printStackTrace();
			rtnMap.put("Errmsg", "오류가 발생하였습니다.");
			rtnMap.put("Errstate", -1);
