...
public class Cm1300Controller {
	...
	public List<Map<String, Object>> cm1300PopMenuSel(@RequestBody Map<String, Object> param) {
		return cm1300Service.cm1300PopMenuSel(param);
	}
	...
	public Map<String, Object> cm1300HeadSave(@RequestBody Map<String, Object> param, @ModelAttribute("User") UserInfo user) {
		
		Map<String, Object> rtnMap = new HashMap<>();
		
		try {
			rtnMap = cm1300Service.cm1300HeadSave(param, user);
		} catch(Exception e) {
			e.printStackTrace();
			rtnMap.put("Errmsg", "오류가 발생하였습니다.");
			rtnMap.put("Errstate", -1);
	...
	public Map<String, Object> cm1300DetailSave(@RequestBody List<Map<String, Object>> param, @ModelAttribute("User") UserInfo user) {
		
		Map<String, Object> rtnMap = new HashMap<>();
		
		try {
			rtnMap = cm1300Service.cm1300DetailSave(param, user);
		} catch(Exception e) {
			e.printStackTrace();
			rtnMap.put("Errmsg", "오류가 발생하였습니다.");
			rtnMap.put("Errstate", -1);
